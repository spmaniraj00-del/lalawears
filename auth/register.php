...
?>
      ...
      <div class="otp-card">
        ...
        <h1>Sign Up</h1>
        <p class="otp-sub">Join us to manage orders, track shipping, and receive notification updates.</p>
        ...
        <?php if (google_configured()): ?>
          <div class="otp-divider">
            <span class="otp-divider-text">Or continue with</span>
            <div class="otp-divider-line"></div>
          </div>

          <a href="<?= e(google_oauth_url()) ?>" class="google-btn">
            <svg viewBox="0 0 24 24" width="20" height="20" style="margin-right: 10px; display: inline-block; vertical-align: middle;">
              <!-- Standard clean Google logo G icon path -->
              ...
              <path fill="#4285F4" d="M22.54 12.27c0-.81-.07-1.59-.2-2.36H12v4.47h5.91c-.25 1.34-1.01 2.48-2.15 3.24v2.77h3.47c2.03-1.87 3.2-4.63 3.2-7.77z"/>
            </svg>
            Sign up with Google
          </a>
        <?php endif; ?>
      ...
      <div class="otp-helpers">
        ...
        <span class="div" style="display:inline-block; width:1px; height:12px; background:rgba(38, 38, 38, 0.15); margin:0 8px; vertical-align:middle;"></span>
