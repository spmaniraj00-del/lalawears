...
?>
      ...
      <div class="otp-card">
        ...
        <?php else: ?>
          <div class="otp-error">Google login is not configured on this server yet. Set <strong>GOOGLE_CLIENT_ID</strong> and <strong>GOOGLE_CLIENT_SECRET</strong> in Railway variables, then redeploy.</div>
        <?php endif; ?>
